...
- Status / Subject commits / Remote branch：`IN_PROGRESS / preflight e3db50d、exact-binding 2c90ea5、receipt 7324957、candidate-contract 91fee72、candidate-contract receipt 98f1f15、G1 repair待提交 / origin/codex/g07-candidate@98f1f15远端回读一致`；
- Verification / Evidence / Gate result / `structurally_valid`：`非P5全量2052 passed, 43 skipped, 0 failed；首轮完整候选回归2554 passed, 44 skipped, 2 failed且两个合同集成问题已定向修复；候选runner 46项可发现 / LOCAL_AUTOMATED_FAILURE_PRESERVED_G1_RETEST_PENDING / HARDENED_CANDIDATE_GATE_NOT_RUN / true`；结构有效和定向修复不代表候选通过；
