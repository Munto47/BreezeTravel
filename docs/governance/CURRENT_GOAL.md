...
- Status / Subject commits / Remote branch：`IN_PROGRESS / 首轮review subject 2c7513e；repair subject待提交 / origin/codex/g07-candidate@2c7513e远端回读一致`；
- Verification / Evidence / Gate result / `structurally_valid`：`首轮同subject G0～G5复验、三角色与ultra已运行；裁决FAIL并采纳2个P1和1个P2；三项修复精确5 passed、扩大60 passed、范围定向47 passed、第二轮全量2575 passed, 44 skipped, 0 failed，Ruff/diff/sensitive scan PASS / MULTI_AGENT_SIMULATED_REVIEW_FAIL + LOCAL_AUTOMATED_REPAIR / HARDENED_CANDIDATE_GATE_NOT_RUN / true`；旧subject证据不等于最终候选通过，sealed blind和固定component verifier仍未完成；
- H1 / production / commercial：`NOT_RUN / NOT_RUN / NOT_RUN`；H1、公网、生产、商业：`NOT_RUN`，release、deploy和`main`未请求；
- User-visible result / Remaining risks / Goal archived：`G06已交付；G07首轮复核发现的描述句误卡、Provider局部事实丢失和share路径日志泄漏均已最小修复 / 新subject尚未提交或完成全量与复审；G0～G8、sealed blind、可验证component receipts和最终HardeningDecision仍须同subject通过 / false`；
