...
- Status / Subject commits / Remote branch：`IN_PROGRESS / preflight e3db50d、exact-binding 2c90ea5、receipt 7324957、candidate-contract 91fee72 / origin/codex/g07-candidate@91fee72远端回读一致`；
- Verification / Evidence / Gate result / `structurally_valid`：`非P5全量2052 passed, 43 skipped, 0 failed；候选合同定向95 passed；frontend build与46条candidate E2E发现PASS / LOCAL_AUTOMATED_EXACT_BINDING_AND_CONTRACT / HARDENED_CANDIDATE_GATE_NOT_RUN / true`；结构有效不代表候选通过；
