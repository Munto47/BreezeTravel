...
10. [`governance/CURRENT_GOAL.md`](governance/CURRENT_GOAL.md) / [`governance/current_work_packages.json`](governance/current_work_packages.json) / [`governance/WORK_PACKAGE_PROMPT_TEMPLATE.md`](governance/WORK_PACKAGE_PROMPT_TEMPLATE.md) / [`governance/ROADMAP.md`](governance/ROADMAP.md) / [`governance/RELEASE_GATES.md`](governance/RELEASE_GATES.md)：唯一开发切片、独立功能对话提示词、并行工作包、阶段顺序和放行合同；
