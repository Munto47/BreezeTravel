...
4. [`governance/CURRENT_GOAL.md`](governance/CURRENT_GOAL.md) / [`governance/ROADMAP.md`](governance/ROADMAP.md)：唯一开发切片与阶段顺序；
5. [`adr/`](adr/)：已接受的架构决策；
...
- `governance/`：Roadmap、Release Gates、单一 Goal 合同和基线；
