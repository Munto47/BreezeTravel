...
- 状态：Superseded by ADR-007、ADR-008、ADR-012（仅Builder/Planner/RAG/运行时多Agent/Yjs冻结决定继续有效）
- 日期：2026-08-22
- 取代范围：ADR-001 中“双入口并行推进”和 P0～P8/M1～M4 阶段顺序
- 适用范围：北京、上海、杭州；2～5 人；2～5 天单城市行程

> 历史边界：本文件的2～5人/2～5天/单城市限制、TripBrief前置确认和P0～P6顺序不再驱动`TC-VNEXT-2026`。当前产品范围与Goal顺序以Blueprint 1.0权威文件为准；本文件只保留上述冻结资产决定和历史原因。
