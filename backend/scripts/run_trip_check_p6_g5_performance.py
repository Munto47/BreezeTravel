"""Run the fail-closed P6 G5 local candidate performance evidence slice."""
...
from evals.trip_check_v1.p6.performance_runner import run_performance_evidence  # noqa: E402
...
def main() -> int:
    ...
    try:
        ...
        print(json.dumps({"status": "REJECT", "reason_code": "P6_G5_PERFORMANCE_INTERNAL_ERROR"}))
        return 1
