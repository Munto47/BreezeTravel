"""Execute the sealed P5 v4 frozen-blind lane exactly once."""
...
from evals.trip_check_v1.p5.runner_v4 import (  # noqa: E402
    BlindDatasetPathsV4,
...
def main(argv: list[str] | None = None) -> int:
    ...
    # Delayed because the dataset/seal v4 slice is integrated independently.
    ...
    except P5BlindRunnerErrorV4 as exc:
        print(
            json.dumps(
                {
                    "schema_version": "trip-check-p5-blind-run-error-v4",
