"""Build the formal P5 v4 Evaluation Gate from sealed, replayed artifacts."""
...
from evals.trip_check_v1.p5.gate_v4 import build_p5_gate_manifest_v4  # noqa: E402
...
def main() -> None:
    ...
    parser.add_argument("--dataset", type=Path, default=P5_ROOT / "dataset_v4.manifest.json")
    ...
    parser.add_argument("--run-spec", type=Path, default=P5_ROOT / "run_spec_template_v4.json")
    ...
    parser.add_argument(
        "--gate-schema", type=Path, default=P5_ROOT / "gate_v4.schema.json"
    )
