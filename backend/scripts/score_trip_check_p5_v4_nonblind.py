"""Validate and score a P5 v4 non-blind run group."""
...
from evals.trip_check_v1.p5.nonblind_scorer_v4 import (  # noqa: E402
...
def main() -> int:
    ...
    try:
        report = score_nonblind_run_group_v4(
            run_dir=args.run_dir.resolve(),
            repo_root=REPO_ROOT,
            require_formal=not args.development,
        )
    except P5NonblindScoringErrorV4 as exc:
        print(
            json.dumps(
                {
                    "schema_version": "trip-check-p5-nonblind-score-error-v4",
