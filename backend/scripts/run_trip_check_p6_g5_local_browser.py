"""Run the fail-closed P6 G5 controlled local-browser evidence slice."""
...
from evals.trip_check_v1.p6.local_browser_runner import run_local_browser_evidence  # noqa: E402
...
def main() -> int:
    ...
    try:
        ...
        print(json.dumps({"status": "REJECT", "reason_code": "P6_G5_LOCAL_INTERNAL_ERROR"}))
        return 1
