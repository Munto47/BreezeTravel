"""Aggregate exactly three independent P5 v5 automated Judge rounds."""
...
def _validate_panel(report: dict[str, object]) -> None:
    ...
    if errors:
        raise RuntimeError(f"P5_V5_JUDGE_PANEL_SCHEMA_INVALID: {errors[0].message}")
...
def main() -> None:
    ...
    report = aggregate_judge_rounds_v5(
        repo_root=REPO_ROOT,
    ...
    if readback != report:
        raise RuntimeError("P5_V5_JUDGE_PANEL_READBACK_FAILED")
    print(payload, end="")
