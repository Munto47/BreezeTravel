"""Run the fail-closed P6 G2 PostgreSQL gate."""
...
from evals.trip_check_v1.p6.postgres_runner import run_postgres_gate  # noqa: E402
    ...
    try:
        receipt = asyncio.run(
            run_postgres_gate(
                ...
                database_admin_url=os.environ.get("TEST_DATABASE_ADMIN_URL"),
            )
        )
        ...
        print(json.dumps({"status": "REJECT", "reason_code": "P6_G2_INTERNAL_ERROR"}))
        return 1
