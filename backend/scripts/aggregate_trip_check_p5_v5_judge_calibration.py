"""Aggregate three independent non-blind P5 Judge calibration rounds."""
...
def main() -> None:
    ...
    report = aggregate_judge_calibration_rounds_v1(
        repo_root=REPO_ROOT,
        key_path=args.key,
    ...
    if json.loads(args.output.read_text(encoding="utf-8")) != report:
        raise RuntimeError("P5_JUDGE_CALIBRATION_PANEL_READBACK_FAILED")
    print(payload, end="")
