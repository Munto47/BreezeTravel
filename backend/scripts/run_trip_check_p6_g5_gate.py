"""Aggregate the fail-closed P6 G5 local, performance, privacy, and public evidence."""
...
from evals.trip_check_v1.p6.g5_runner import run_g5_gate  # noqa: E402
...
def main() -> int:
    ...
    try:
        ...
        print(json.dumps({"status": "REJECT", "reason_code": "P6_G5_INTERNAL_ERROR"}))
        return 1
