"""Run the fail-closed P6 G0 repository and authority gate."""
...
from evals.trip_check_v1.p6.repository_runner import run_repository_gate  # noqa: E402
...
def main() -> int:
    ...
    try:
        ...
        print(json.dumps({"status": "REJECT", "reason_code": "P6_G0_INTERNAL_ERROR"}))
        return 1
