    ...
    *,
    ...
    general_contract = {
        ...
        "parallel_development": {
            ...
            "integrator_execution_mode": "PRIMARY_INTEGRATOR_DIALOGUE",
            "contributor_execution_mode": "INDEPENDENT_FUNCTION_DIALOGUE",
            "subagent_writer_authority": False,
            "max_parallel_writers": 3,
            "integrator_always_consumes_writer_slot": True,
            "max_concurrent_function_dialogues": 2,
            "waiting_status": "WAITING_FOR_WRITER_SLOT",
            "prompt_contract_version": "work-package-prompt-v1",
            "prompt_branch_worktree_dialogue_binding_required": True,
            "ready_commit_clean_remote_readback_required": True,
            "max_goal_ahead": 1,
            "max_prepared_next_goal_packages": 2,
            "non_matching_guidance_or_binding": "READ_ONLY",
            "parallel_development_serial_integration": True,
            "integration_order": "DOMAIN_BACKEND_API_UI_E2E",
        },
        "required_scenarios": [
            "normal",
            "ambiguous",
    ...
    sealed_thresholds = {
        ...
        "required_metric_names": [
            ...
            "role_macro_f1",
            "deep_city_auto_match.coverage",
            "estimated_confirmation_required_count.median",
            "estimated_confirmation_required_count.p90",
        ...
        "conditions": [
            ...
            {
                "metric": "deep_city_auto_match.coverage",
                "operator": "GE",
                "value": 0.8,
            },
            {
                "metric": "estimated_confirmation_required_count.median",
                "operator": "LE",
                "value": 1,
            },
            {
                "metric": "estimated_confirmation_required_count.p90",
                "operator": "LE",
                "value": 3,
            },
