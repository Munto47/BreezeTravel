...
def run_gate(
    ...
    expected_binding = {
        ...
        "dataset_manifest_sha256": hashlib.sha256((data_root / "manifest.json").read_bytes()).hexdigest(),
...
def main() -> None:
    ...
    print(
        json.dumps(
            run_gate(args.data_root, args.predictions, args.external_blind_labels, args.run_spec),
            ensure_ascii=False,
            sort_keys=True,
        )
    )
