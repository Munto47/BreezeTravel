...
def build_p5_gate_manifest_v2(
    *,
    ...
    scanned_paths = [
        ...
        nonblind_run_dir / "failure_records.jsonl",
        nonblind_run_dir / "artifact_index.json",
        nonblind_score_path.resolve(),
        blind_run_dir / "run_group_manifest.json",
        blind_run_dir / blind_run["terminal_outputs_path"],
        blind_run_dir / "failure_records.jsonl",
        blind_run_dir / "artifact_index.json",
    ...
    artifacts = [
        ...
        _artifact("nonblind_failure_records", nonblind_run_dir / "failure_records.jsonl", root),
        _artifact("nonblind_artifact_index", nonblind_run_dir / "artifact_index.json", root),
        ...
        _artifact("blind_failure_records", blind_run_dir / "failure_records.jsonl", root),
        _artifact("blind_artifact_index", blind_run_dir / "artifact_index.json", root),
