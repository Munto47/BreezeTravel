...
G07_UPSTREAM_REF = "origin/codex/g07-candidate-cycle-3"
G07_REMOTE_REF = "refs/heads/codex/g07-candidate-cycle-3"
...
def _verify_g07_contract(repo_root: Path) -> dict[str, str]:
    ...
    if not (
        ...
        and candidate.get("branch") == "codex/g07-candidate-cycle-3"
