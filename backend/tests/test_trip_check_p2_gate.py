...
from scripts.run_trip_check_p2_reliability_gate import DEFAULT_OUTPUT, _safe_reset_output, _write_json
...
def test_gate_json_artifacts_are_lf_normalized(tmp_path: Path):
