...
module.exports = defineConfig({
  testDir: './e2e',
  testMatch: ['trip-check-p3.spec.js'],
  timeout: 30_000,
  fullyParallel: false,
  retries: 0,
  metadata: {
    ...
    input_cases: ['screenshot_cleanup_receipt', 'privacy_blocked_fail_closed'],
  ...
  reporter: [
    ['list'],
    ['json', { outputFile: '../backend/evidence/trip_check_v1/p3/browser-playwright.json' }],
  ],
  webServer: {
